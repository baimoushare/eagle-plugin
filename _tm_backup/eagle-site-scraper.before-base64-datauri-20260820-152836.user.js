...
(function() {
     ...
     * @returns {Promise<void>}
     */
    async function saveBlobLocally(blob, fileName, directoryHandle = null) {
    ...
    const UIPanel = {
        ...
        async pickLocalDirectory() {
            ...
            try {
                ...
                this.setStatus('选择本地目录失败，将使用默认下载文件夹', 'error');
            }
        },
        ...
        syncLocalDirectoryLabel() {
            ...
            if (!trigger) return;
            trigger.textContent = this.localDirectoryHandle ? this.localDirectoryHandle.name : '默认下载文件夹';
        },
