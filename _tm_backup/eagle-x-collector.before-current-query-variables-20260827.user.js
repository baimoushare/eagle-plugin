...
`)
        ...
        fetchJson: async function (status_id) {
            ...
            const operationId = await this.getGraphQLOperationId('TweetResultByRestId', currentKnownOperationId)
            let variables = {
                'tweetId': status_id,
            ...
            for (const candidateId of Array.from(new Set([operationId, currentKnownOperationId])).filter(Boolean)) {
                try {
